...
insert into car_owner (id, name, surname, age) values (1001,'Marek','Mankowski',34);
...
insert into car (id, registration_number, car_owner_id) values (900,'WB47382', 1001);
...
insert into parking_space (id, car_owner_id) values (1002,1001);
